...
type DogUpdateAdapter interface {
	DogUpdateExecute(dog *core_dog.DogEntity) (*core_dog.DogEntity, error)
}

func DogUpdateUsecase(repository core_dog_repository.DogRepositoryAdapter) func(input *core_dog.DogEntity) (*core_dog.DogEntity, error) {
	return func(input *core_dog.DogEntity) (*core_dog.DogEntity, error) {
